...
public class Common {
    ...
    public static final String DRIVER_INFOR_REFERENCE = "Driver Info";
    ...
    public static void showNotification(Context context, int id, String title, String body, Intent intent) {
        ...
        if (intent !=null)  {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANEL_ID,"Uber", NotificationManager.IMPORTANCE_HIGH);
            ...
            builder.setContentTitle(title)
                    ...
                    .setSmallIcon(R.drawable.ic_baseline_car_s4)
                    .setLargeIcon(BitmapFactory.decodeResource(context.getResources(),R.drawable.ic_baseline_car_s4));
    ...
    public static String buildName(String firstName, String phoneNumber) {
        return new StringBuilder(firstName).append(" ").append(phoneNumber).toString();
    }
